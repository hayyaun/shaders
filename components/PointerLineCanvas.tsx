...
interface PointerLineCanvasProps {
  width?: number; // Canvas width in pixels
}

export interface PointerLineCanvasRef {
  getCanvas: () => HTMLCanvasElement | null;
}

export const PointerLineCanvas = forwardRef<PointerLineCanvasRef, PointerLineCanvasProps>(
  ({ width = 200 }, ref) => {
...
PointerLineCanvas.displayName = 'PointerLineCanvas';
